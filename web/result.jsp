    ...
    <body>
        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="register.html"><span class="glyphicon glyphicon-search"></span>My Booking</a></li>
        ...
        <div class="container col-sm-9">
            <div style="margin: 0 0 0 35%">
                <h2>Sydney <-> Hong Kong</h2>
                <div class="panel-group">
                    <div class="panel panel-default">
                        <div class="panel-heading clearfix">
                            <p class="panel-title pull-left" style="padding-top: 7.5px;">Click one of Flight to check</p>
