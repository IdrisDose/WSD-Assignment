...
<html>
    ...
    <body>
        <%
            ...
            if(currUser!=null)
                isMember= currUser.getStatus().equals("member");
            
            //True if user is not null and a member, therefore the current session user variable would have a value (logged in)
            boolean isLoggedIn = currUser != null && isMember;
            
            String disabled = isLoggedIn ? "" : "disabled";
        %>
                ...
                <div class="panel-group">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form  class="form-horizontal" role="form" method="POST" action="booking_details.jsp">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        %>
                                        <tr>
                                            <td><input type="radio" name="flightid" value="<%=flight.getId()%>" <%=disabled%>/> <%=flight.getId()%></td>
